...
public class StreamCrypto {
	...
	private static byte[] streamEncrypt(Cipher cipher, Mac mac, Key key,
		...
		byte[] encBuf = Compatibility.copyOfRange(data, offset, offset + len);
	 ...
	 */
	public static byte[] computeChainIv(EncFSVolume volume, String volumePath) throws UnsupportedEncodingException {
