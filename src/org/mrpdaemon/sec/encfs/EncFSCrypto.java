...
public final class EncFSCrypto {
	...
	private static IvParameterSpec newIvSpec(Mac mac, byte[] iv, byte[] ivSeed) {
		...
		byte[] ivResult = Compatibility.copyOfRange(mac.doFinal(concat), 0,
	...
	static byte[] getBytesForBlockAlgorithm(String curPath) throws UnsupportedEncodingException {
	...
	static byte[] computeChainedIV(EncFSVolume volume, String volumePath,
			EncFSConfig config) throws UnsupportedEncodingException {
